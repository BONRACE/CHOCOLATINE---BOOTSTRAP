...
- **Public** : catalogue avec recherche/filtres HTMX (`/`) → détail événement
  ...
  avec informations "visa" par participant, photo comprise
  (`/checkout/<cart_id>/`) → confirmation avec QR + PDF téléchargeable, un
  billet par personne (`/tickets/confirmation/<uuid>/`)
